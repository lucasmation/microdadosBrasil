...
```{r echo=FALSE}
d <- data.frame(
  Source=c('IBGE','IBGE','IBGE','IBGE','MTE','INEP','INEP'),
  Dataset=c('PNAD','PNAD Contínua','Censo Demográfico','POF','RAIS','Censo Escolar','Censo da Educ. Superior'),
  Import_function=c('read_PNAD','read_PNADcontinua','read_CENSO','read_POF','read_RAIS','read_CensoEscolar','read_CensoEducacaoSuperior'),
  Period=c('2001 to 2014','2012.1 to 2016.1','2000,2010','2008','1997 to 2014','1995 to 2014','1995 to 2014'),
  Subdataset=c('domicilios, pessoas','pessoas','domicilios, pessoas','vínculos','several, see details','escolas, ..., see detials','see details')
  )
library(printr)
d
```
